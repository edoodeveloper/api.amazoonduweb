...
module.exports = {
    ...
    createEvent: async (req, res) => {
        try {
            ...
            form.parse(req, async (err, fields, files) => {
                ...
                if (!fields['eventDate'] || !fields['eventDate'][0]) {
                    return res.json({
                        success: false,
                        message: `La date de l'evenement est obligatoire !`,
                    });
                }
                ...
                const newEvent = await eventModel.createEvent(formData);
    ...
    getEventById: async (req, res) => {
        try {
            ...
            const action = await eventModel.getEventById(actionId);
    ...
    getEvents: async (req, res) => {
        try {
            ...
            all = await eventModel.getEvents(page, per_page, whereClause);
    ...
    updateEventById: async (req, res) => {
        try {
            ...
            const response = await eventModel.getEventById(id);
            ...
            form.parse(req, async (err, fields, files) => {
                ...
                if (fields['eventDate'] && fields['eventDate'][0]) {
                    fieldsToUpdate.eventDate = fields['eventDate'][0];
                }
                ...
                await eventModel.updateEvent(id, fieldsToUpdate);
                res.status(200).json({
                    success: true,
