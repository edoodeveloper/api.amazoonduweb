...
module.exports = {
    ...
    createActivity: async (req, res) => {
        try {
            ...
            form.parse(req, async (err, fields, files) => {
                ...
                const newActivity = await activityModel.createActivity(formData);
    ...
    getActivityById: async (req, res) => {
        try {
            ...
            const action = await activityModel.getActivityById(actionId);
    ...
    getActivities: async (req, res) => {
        try {
            ...
            all = await activityModel.getActivities(page, per_page, whereClause);
    ...
    updateActivityById: async (req, res) => {
        try {
            ...
            const response = await activityModel.getActivityById(id);
            ...
            form.parse(req, async (err, fields, files) => {
                ...
                await activityModel.updateActivity(id, fieldsToUpdate);
                res.status(200).json({
                    success: true,
