...
module.exports = {
    ...
    createAction: async (req, res) => {
        try {
            ...
            form.parse(req, async (err, fields, files) => {
                ...
                const newAction = await actionModel.createAction(formData);
    ...
    getActionById: async (req, res) => {
        try {
            ...
            const action = await actionModel.getActionById(actionId);
    ...
    getActions: async (req, res) => {
        try {
            ...
            all = await actionModel.getActions(page, per_page, whereClause);
    ...
    updateActionById: async (req, res) => {
        try {
            ...
            const response = await actionModel.getActionById(id);
            ...
            form.parse(req, async (err, fields, files) => {
                ...
                await actionModel.updateAction(id, fieldsToUpdate);
                res.status(200).json({
                    success: true,
